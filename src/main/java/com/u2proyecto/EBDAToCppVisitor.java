...
public class EBDAToCppVisitor extends EBDABaseVisitor<String> {
    ...
    public String visitExpression(ExpressionContext ctx) {
        ...
        if (ctx.getText().equals("online")) return "true";
        if (ctx.getText().equals("offline")) return "false";
        if (ctx.getText().equals("npc")) return "nullptr";
    ...
    private String mapTipo(String tipo) {
        switch (tipo) {
            case "healthpoints": return "int";
            case "chat": return "string";
            case "online": return "bool";
            default: return "auto";
        }
    }
}