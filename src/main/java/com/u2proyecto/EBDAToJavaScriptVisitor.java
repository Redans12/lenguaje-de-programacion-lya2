...
public class EBDAToJavaScriptVisitor extends EBDABaseVisitor<String> {
    ...
    public String visitPrintStmt(PrintStmtContext ctx) {
        String valor = visit(ctx.expression());
        return indent() + "console.log(" + valor + ");\n";
    }
    ...
    public String visitExpression(ExpressionContext ctx) {
        ...
        if (ctx.getText().equals("npc")) return "null";
